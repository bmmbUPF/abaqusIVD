...
C Write the design to the file
      ...
      WRITE(15,*) ' '
      WRITE(15,*) ' Osmo-Poro-Hyper-Viscoelastic Model for the IVD'
      WRITE(15,*) ' Type: User MATerial (UMAT)'
      WRITE(15,*) ' '
      WRITE(15,*) ' Auth: Adrea Malandrino, 5/10/2012'
      WRITE(15,*) ' Updates:'
      WRITE(15,*) '-Carlos Ruiz, 23/07/2024'
      WRITE(15,*) ' Added strain-dependent permeability calculation'
      WRITE(15,*) '-Estefano Muñoz-Moya, 05/08/2024'
      WRITE(15,*) ' Mechano-Transport model compatibility'
      WRITE(15,*) ' '
     ...
     1, date_ini(4)
      ...
      WRITE(15,*) '----------------------------------------------------'
      WRITE(15,*) ' '
      WRITE(15,*) 'TYPE OF ELEMENT: C3D20P'
      WRITE(15,*) '-----------------------'
      WRITE(15,*) ' '
      ...
      WRITE(15,*) 'Larget id number for the elements: ', numIdElem

      WRITE(15,*) ' '
      WRITE(15,*) '****************************************************'
      WRITE(15,*) '        THE STATEV USED IN THE SUBROUTINE'
      WRITE(15,*) '****************************************************'
      WRITE(15,*) ' '
      CALL Initialize_STATEV_NAMES()
      DO I=1,SIZE(STATEV_NAMES)
            WRITE(15,'(A,I3,A)') ' STATEV(',I,'):'
            WRITE(15,*) STATEV_NAMES(I)
      END DO
      WRITE(15,*) ' '
      WRITE(15,*) '****************************************************'
      ...
      PRINT *, ' '
      PRINT *, ' Osmo-Poro-Hyper-Viscoelastic Model for the IVD'
      PRINT *, ' Type: User MATerial (UMAT)'
      PRINT *, ' '
      PRINT *, ' Auth: Adrea Malandrino, 5/10/2012'
      PRINT *, ' Updates:'
      PRINT *, '-Carlos Ruiz, 23/07/2024'
      PRINT *, ' Added strain-dependent permeability calculation'
      PRINT *, '-Estefano Muñoz-Moya, 05/08/2024'
      PRINT *, ' Mechano-Transport model compatibility'
      PRINT *, ' '
     ...
     1, date_ini(4)
      ...
      PRINT *, 'Larget id number for the elements: ', numIdElem
      PRINT *, ' '
      PRINT *, '****************************************************'
      PRINT *, '        THE STATEV USED IN THE SUBROUTINE'
      PRINT *, '****************************************************'
      PRINT *, ' '
      DO I=1,SIZE(STATEV_NAMES)
            PRINT '(A,I3,A)', ' STATEV(',I,'):'
            PRINT *, STATEV_NAMES(I)
      END DO
      PRINT *, ' '
      PRINT *, '****************************************************'
      PRINT *, ' '
...
C Opening file and write summary
     ...
     1KSTEP, KINC, ITERATION/numInt, TIME(2), TIME(1), DTIME, ' '
